...
*/
	...
	$sql1 = mysql_query("select sum(amount) from s_return");
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='s_return.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from s_return ORDER BY id DESC  limit $cps, $rpp "; 
...
if (isset($_GET['id']))
	{
		...
		$sql = "DELETE FROM s_return WHERE id ='$id'";
...
<p>&nbsp;</p>
			<p>&nbsp;</p>
		  <p><? echo "Showing Records from $a to $b of $nr0"; ?></p>
            
			<table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="12" align="center"><div class="alert alert-success" role="alert"><strong>SALES RETURN</strong></div></td>
		      </tr>
			  <tr>
			    <td height="30" colspan="12" align="left"><span class="cred">TOTAL SALES RETURN: </span><span class="cgreen"><strong>&#8358;<?php echo number_format($t_amount,2); ?></strong></span></td>
		      </tr>
			  <tr>
			    ...
			    <td width="78" align="center"><strong>Unit Price(&#8358;)</strong></td>
			    <td width="101" align="center"><strong>Total Amount(&#8358;)</strong></td>
			    <td width="156" align="center"><strong>Reasons</strong></td>
			    <td width="50" align="center"><strong>Date</strong></td>
			    <td width="92" align="center"><strong>Returned By</strong></td>
		      </tr>
						  <?php
	...
	?>
  <tr>
			    <td width="43" height="30" align="center"><a href="v_stock.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
			    <td width="97" height="30"><?php echo $myr_no; ?></td>
			    <td width="114" align="left"><?php echo $myitem; ?></td>
			    <td width="114" align="left"><?php echo $myp_name; ?></td>
			    <td width="114" align="left"><?php echo $mybatch; ?></td>
			    <td width="71" align="left"><?php echo $myqty; ?></td>
			    <td align="right"><?php echo number_format($rate,2); ?></td>
	    <td align="right"><?php echo number_format($myt_amt,2); ?></td>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='s_return.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
