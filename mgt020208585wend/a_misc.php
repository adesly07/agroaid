...
$t_amt = ($amt);
$sql2 = mysql_query ("insert into stocks set category = 'Miscellaneous', type = '$desc', quantity = '$qty', unit = '$desc', u_price = '$amt', t_amt = '$t_amt', s_date = '$s_date', c_by = '$name', ip = '$ip'");
if ($sql2) {
$msg = "Miscellaneous Added Successfully";
} else {
//die(mysql_error());
$msg = "Error In Adding Miscellaneous";
}
}
...
<?php include ('menu.php'); ?>   
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Add Miscellaneous </h2>
				<div class="sign-up-row widget-shadow">
<div class="alert alert-success" role="alert">
<strong><?php echo $msg;?></strong></div>
<form action="a_misc.php" method="post" enctype="multipart/form-data">
<div class="sign-u">
  <div class="clearfix"> </div>
</div>
					<div class="sign-u">
      ...
      <p>
          ...
          <p><strong>Total Amount</strong></p>
                    <p>
            <input type="text" name="amt" placeholder="Total Amount" required="" id="amt">
          </p>
...
<input type="submit" name="Submit" value="Add">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="6" align="center"><div class="alert alert-success" role="alert"><strong>Miscellaneous</strong></div></td>
		      </tr>
			  <tr>
			    <td width="430" height="30" align="center"><strong>Description</strong></td>
			    <td width="127" align="center"><strong>Quantity</strong></td>
			    <td width="113" align="center"><strong>Amount(&#8358;)</strong></td>
  ...
  <tr>
	    ...
	    <td align="center"><a href="a_misc.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p><a href="mis.php">View All</a></p>
<p>&nbsp;</p>
