...
*/
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='sales_report5.php?cps=$lps'><<=</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from sales where year = '$year' and p_status = 'PAID' order by id ASC limit $cps, $rpp "; 
...
<tr>
  ...
  while ($row = mysql_fetch_array($rs)) {
 	$cps = $cps +1;
		...
		$batch = $row['batch'];
		$p_name = $row['p_name'];
$sql4 = mysql_query("select sum(amount) from sales where year = '$year' and p_status = 'PAID'");
  ...
  ?>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='sales_report5.php?cps=$cps&lps=$lps'>=>></a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
