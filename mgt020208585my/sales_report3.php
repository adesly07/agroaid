...
*/
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='sales_report3.php?cps=$lps'><<=</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from sales where month = '$month' and year = '$year' and p_status = 'PAID' order by id ASC limit $cps, $rpp "; 
...
<tr>
			    <td width="69" align="center"><div class="alert alert-success" role="alert"><strong>GRANT SALES REPORT FOR THE MONTH OF <?php echo strtoupper($month); ?>, <?php echo $year; ?></strong></div></td>
		      </tr>
			  <tr>
			    <td height="30" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-hover">
			      <tr>
  ...
  while ($row = mysql_fetch_array($rs)) {
 	$cps = $cps +1;
		...
		$batch = $row['batch'];
		$p_name = $row['p_name'];
 $sql4 = mysql_query("select sum(amount) from sales where month = '$month' and year = '$year' and p_status = 'PAID'");
...
$t_amt = $row[0];	
  ...
  ?>
			          <tr>
			            <td height="30" bgcolor="#F8F8F8"><?php echo $r_no; ?></td>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='sales_report3.php?cps=$cps&lps=$lps'>=>></a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
