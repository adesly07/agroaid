...
$sql1 = mysql_query("select * from medication where m_type = '$m_type'");
if(mysql_num_rows($sql1)) {
$msg = "Record Already Exist";	
} else {
$sql2 = mysql_query ("insert into medication set m_type = '$m_type', c_by = '$name', ip = '$ip'");
if ($sql2) {
...
<?php include ('menu.php'); ?>   
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Create Medication Type</h2>
				<div class="sign-up-row widget-shadow">
<div class="alert alert-success" role="alert">
<strong><?php echo $msg;?></strong></div>
<form action="medication.php" method="post" enctype="multipart/form-data">
<div class="sign-u">
  <div class="clearfix"> </div>
</div>
					<div class="sign-u">
          <p>
            <input type="text" name="m_type" placeholder="Medication Name" required="" id="m_type" autofocus>
          </p>
<div class="sub_home">
<input type="submit" name="Submit" value="Add">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="400" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="3" align="center"><div class="alert alert-success" role="alert"><strong>Medication Type</strong></div></td>
		      </tr>
			  <tr>
			    <td height="30" align="left"><strong>Medication Name</strong></td>
			    <td align="left"><strong>Created By</strong></td>
			    <td width="70" align="center">&nbsp;</td>
		      </tr>
			  <?php
	 $sql3 = mysql_query("select * from medication order by id desc");
	...
	?>
			  <tr>
			    <td width="166" height="30"><?php echo $mym_type; ?></td>
			    <td width="156" align="left"><?php echo $myc_by; ?></td>
			    <td align="center"><a href="medication.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
