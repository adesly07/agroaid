				...
				<div class="profile_details_left"><!--notifications of menu start -->
					<ul class="nofitications-dropdown">
					  <li class="dropdown head-dpdn">
						...
						| <a href="index.php">Back </a> | <a href="m_report.php">Monthly Report</a> | <a href="y_report.php">Yearly Report</a></li>
                    </ul>
...
<div class="main-page signup-page">
				<h2 class="title1">DAILY SALES REPORT</h2>
				<div class="sign-up-row widget-shadow">
<div class="alert alert-success" role="alert">
<strong><?php echo $msg;?></strong></div>
<form action="s_report.php" method="post" enctype="multipart/form-data">
<div class="sign-u">
  <div class="clearfix"> </div>
</div>
<p>
		    <input name="s_date" type="text" id="s_date" readonly="readonly" value="<?php echo date('d/m/Y'); ?>" required="">
	      <img src="images2/cal.gif" alt="" style="cursor:pointer" onclick="javascript:NewCssCal('s_date','ddMMyyyy','arrow')"/>								</p>
<p>&nbsp;</p>
<p>
