...
if (isset($_GET['id']))
	{
		...
		$sql = "DELETE FROM m_mgt2 WHERE id ='$id'";
...
<body class="cbp-spmenu-push">
	<p><a href="index.php">Back</a> | <a href="history.php">Daily Feeding</a> | <strong>Medication</strong> | <a href="v_history.php">Vaccination</a></p>
	<p>
	  <!-- side nav js -->
  ...
  <div class="col-md-12  widget-shadow">
        ...
        <div class="inbox-page">
          ...
          <div class="bs-example widget-shadow" data-example-id="hoverable-table">
            <table width="100%" border="1" cellpadding="0" cellspacing="0" class="table table-hover">
              <thead>
                <tr>
                  <td colspan="2" align="center"><span class="cgreen"><strong>MEDICATION HISTORY</strong></span></td>
                </tr>
                <tr>
                  <th>Medication (Supervisor Record)</th>
                  <th>Medication (Admin Record)</th>
                </tr>
                <tr>
                  <td width="9%"> <div class="bs-example widget-shadow" data-example-id="hoverable-table">
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="table table-hover">
                      ...
                      <tbody>
                        <?php
	 $sql3 = mysql_query("select * from m_mgt order by id desc limit 30 ");
	...
	?>
                        <tr>
                          ...
                          <td scope="row"><?php echo $m_date; ?></td>
                          <td><?php echo $m_time; ?></td>
                          <td><?php echo $b_type; ?></td>
                          <td><?php echo $m_used; ?></td>
                  ...
                  <td width="9%"> <div class="bs-example widget-shadow" data-example-id="hoverable-table">
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="table table-hover">
                      ...
                      <tbody>
                        <?php
	 $sql4 = mysql_query("select * from m_mgt2 order by id desc limit 30");
	...
	?>
                        <tr class="cred">
                          ...
                          <td height="30" scope="row"><a href="v_medi.php?id=<?php echo $mysn; ?>" rel="facebox"><?php echo $mym_date; ?></a></td>
                          <td><?php echo $mym_time; ?></td>
                          <td><?php echo $myb_type; ?></td>
                          <td><?php echo $mym_used; ?></td>
                          ...
                          <td align="center"><a href="m_history.php?id=<?php echo $mysn; ?>" onClick="return check_deletion()"><img src="images/delete.png" width="16" height="16"></a></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
