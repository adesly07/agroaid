...
if ($pwd != $confirm) {
$msg = "Password does not the match. Try Again.";	
} else {
$sql2 = mysql_query ("update create_login set password = '$pwd' where username = '$user' ");
if ($sql2) {
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Edit Password</h2>
...
<p>
            <input name="username" type="text" id="username" value="<? echo $username; ?>" readonly="readonly" placeholder="Username" required="">
          </p>
          <p>
            <input name="password" type="password" id="password" value="<? echo $password; ?>" placeholder="Password" required="">
          </p>
          <p>
