...
$sql2 = mysql_query ("insert into create_login set name = '$u_name', username = '$username', password = '$password', section = '$section'");
if ($sql2) {
...
if (isset($_GET['id']))
	{
		...
		$sql = "DELETE FROM create_login WHERE cid ='$id'";
...
<form action="c_user.php" method="post" enctype="multipart/form-data">
<div class="sign-u">
  <div class="clearfix"> </div>
</div>
					<div class="sign-u">
          <p>
            <input type="text" name="name" placeholder="Name" required="" id="name" autofocus>
          </p>
          <p>
            <input type="text" name="username" placeholder="Username" required="" id="username">
          </p>
          <p>
            <input name="password" type="password" id="password" value="" placeholder="Password" required="">
          </p>
          <p>
...
<input type="submit" name="Submit" value="Create">
			...
			<table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
			  <tr>
			    <td colspan="2" align="center"><div class="alert alert-success" role="alert"><strong>Registered Users</strong></div></td>
		      </tr>
			  <?php
	 $sql3 = mysql_query("select * from create_login");
	...
	?>
			  <tr>
			    <td height="30"><?php echo $myuser; ?></td>
			    <td align="center"><a href="c_user.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
