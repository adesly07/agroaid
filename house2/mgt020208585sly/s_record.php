...
<tr>
			    <td width="69" align="center"><div class="alert alert-success" role="alert"><span class="stock"><strong>SALES RECORD</strong></span></div></td>
		      </tr>
			  <tr>
			    <td height="30" align="left"><table width="500" border="0" cellspacing="0" cellpadding="0" class="table table-hover">
			      <tr>
			        <td><form name="form1" method="post" action="s_record.php">
			          <input type="text" id="search" name="search"  placeholder = "Enter Receipt No" class="auto" autofocus="autofocus">
              ...
              <tr>
                <td height="30"><strong class="cred">RECORD LIST FOR RECEIPT NO: <?php echo $search; ?></strong></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="240" align="center"><strong>ITEM</strong></td>
                <td width="156" align="center"><strong>PRICE(&#8358;)</strong></td>
                <td width="126" align="center"><strong>AMOUNT(&#8358;)</strong></td>
                <td width="95" align="center">&nbsp;</td>
                <td width="95" align="center">&nbsp;</td>
                </tr>
              <?php
		 $sql3 = mysql_query("select * from sales where r_no = '$search' and p_status = 'PAID'");
...
$t_amt = $row[0];	
		 ...
		 ?>
              <tr>
                ...
                <td height="20"><?php echo $item; ?></td>
                <td height="20" align="right"><?php echo number_format($rate,2); ?></td>
          ...
          <tr>
            <td align="right"><strong class="cred">TOTAL AMOUNT(&#8358;): </strong><strong class="cgreen"><?php echo number_format($t_amt, 2); ?></strong></td>
          </tr>
        </table></td>
      </tr>
		  </table>
