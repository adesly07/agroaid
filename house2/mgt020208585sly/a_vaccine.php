...
$t_amt = ($u_price * $qty);
$unit = ($qty * $q_unit);
$sql2 = mysql_query ("insert into stocks set category = 'Vaccine', type = '$type', quantity = '$qty', unit = '$unit', u_price = '$u_price', t_amt = '$t_amt', s_date = '$s_date', c_by = '$name', ip = '$ip'");
if ($sql2) {
$msg = "Vaccine Stocked Successfully";
} else {
//die(mysql_error());
$msg = "Error In Stocking Vaccine";
}
}
...
<?php include ('menu.php'); ?>   
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Add Vaccine </h2>
				<div class="sign-up-row widget-shadow">
<div class="alert alert-success" role="alert">
<strong><?php echo $msg;?></strong></div>
<form action="a_vaccine.php" method="post" enctype="multipart/form-data">
<div class="sign-u">
  <div class="clearfix"> </div>
</div>
					<div class="sign-u">
...
<p>&nbsp;</p>
          <p><strong>Quantity/Pack</strong></p>
  <p>
            <input type="text" name="qty" placeholder="Quantity/Pack" required="" id="qty">
  </p>
  <p><strong>Quantity/Unit</strong></p>
                   <p>
            <input type="text" name="q_unit" placeholder="Quantity/Unit" required="" id="q_unit">
                   </p>
          <p><strong>Quantity/Pack</strong></p>
          <p>
            <input type="text" name="u_price" placeholder="Price/Pack" required="" id="u_price">
          </p>
...
<input type="submit" name="Submit" value="Add">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="4" align="center"><div class="alert alert-success" role="alert"><strong>Vaccine Stocked</strong></div></td>
		      </tr>
			  <tr>
			    ...
			    <td width="24" align="center">&nbsp;</td>
						  ...
						  <?php
	 $sql3 = mysql_query("select * from stocks where category = 'Vaccine' order by id desc limit 5");
	...
	?>
  <tr>
			    <td width="69" height="30"><?php echo $mytype; ?></td>
			    <td width="99" align="left"><?php echo $myqty; ?></td>
			    <td align="right"><?php echo number_format($myprice,2); ?></td>
	    <td align="center"><a href="a_vaccine.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
