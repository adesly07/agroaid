...
/////////////
$sql10 = mysql_query("select sum(t_amt) from stocks where category = 'Miscellaneous'");
...
$misc_amt = $row[0];	
 ...
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='m_account.php?cps=$lps'><<=</a>"; 
    } 
    else    
    { 
...
<tr>
			    <td width="69" align="center"><div class="alert alert-success" role="alert"><strong>OVERALL MISCELLANEOUS ACCOUNT  SUMMARY</strong></div></td>
		      </tr>
              <tr>
                <td height="30"><strong>Total Amount(&#8358;):</strong><strong class="cgreen"><?php echo number_format($misc_amt,2); ?></strong></td>
              </tr>
              <tr>
...
$misc_amt = $row[0];	
	...
	?>
                  <tr>
                    <td align="center"><?php echo $cps; ?></td>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='m_account.php?cps=$cps&lps=$lps'>=>></a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
