...
$id = $_REQUEST['id'];
	 $sql3 = mysql_query("select * from f_mgt2 where id = '$id'");
	...
	$sql1 = mysql_query("select sum(mortality) from f_mgt2 where batch = '$batch' and p_name = '$p_name'");
...
<td width="62%" height="30" align="left"><?php echo $f_date; ?></td>
						</tr> 
					    </thead> <tbody>
           ...
           <td height="30" align="left"><?php echo $f_time; ?></td>
                         ...
                         <tr>
                           <td height="30" scope="row"><strong>Mortality Rate (<span class="cred"><?php echo $mortal; ?></span>)</strong></td>
