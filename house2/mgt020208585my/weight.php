...
$sql4 = mysql_query("select sum(f_qty) from f_mgt where batch = '$batch' and p_name = '$p_name'");
...
$myc_qty = ($c_qty - $mortal);
$f_bird = ($f_qty/$myc_qty);
$t_fcr = ($f_bird/$weight);
$sql2 = mysql_query ("insert into weight set batch = '$batch', c_type = '$c_type', p_name = '$p_name', age = '$age', weight = '$weight', c_qty = '$myc_qty', f_qty = '$f_qty', t_fcr = '$t_fcr', comment = '$comment', s_date = '$s_date', c_by = '$name', ip = '$ip'");
if ($sql2) {
  ...
  <div class="clearfix"> </div>
          ...
          <p><span class="sign-u">
			...
			?>
                    ...
                    <p>&nbsp;</p>
          <p><strong>Age in Day(s)</strong></p>
          <p>
            <input type="text" name="age" placeholder="Age in day" required="" id="age">
          </p>
...
<input type="submit" name="Submit" value="Add">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="8" align="center"><div class="alert alert-success" role="alert"><strong>Weight Management</strong></div></td>
		      </tr>
			  <tr>
			    ...
			    <td width="24" align="center">&nbsp;</td>
						  ...
						  <?php
	 $sql3 = mysql_query("select * from weight order by id desc limit 5");
  ...
  <tr>
			    ...
			    <td width="99" align="center"><?php echo $myage; ?></td>
			    <td width="99" align="center"><?php echo $myweight; ?></td>
			    <td width="99" align="center" class="cgreen"><?php echo round($myt_fcr,1); ?>:1</td>
