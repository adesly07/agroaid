...
//$batch = $_SESSION['batch'];
 ...
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='a_summary.php?cps=$lps'><<=</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from u_batch order by batch asc limit $cps, $rpp "; 
...
<tr>
			    <td width="69" align="center"><div class="alert alert-success" role="alert"><strong>OVERALL ACCOUNT SUMMARY</strong></div></td>
		      </tr>
              <tr>
              ...
              <tr>
                <td height="30"><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
                  <tr>
                    <td width="74" align="center" bgcolor="#F8F8F8"><strong>#</strong></td>
                    <td width="109" align="center" bgcolor="#F8F8F8"><strong>Pen</strong></td>
                    <td width="109" align="center" bgcolor="#F8F8F8"><strong>Batch</strong></td>
                    <td width="50" align="center" bgcolor="#F8F8F8"><strong>Expenses(&#8358;)</strong></td>
                    <td width="73" align="center" bgcolor="#F8F8F8"><strong>Income(&#8358;)</strong></td>
                    <td width="40" align="center" bgcolor="#F8F8F8"><strong>Balance(&#8358;)</strong></td>
                  </tr>
                  <?php
...
$_SESSION['p_name'] = $p_name;
  ?>
                  <tr>
                    <td bgcolor="#F8F8F8" align="center"><?php echo $cps; ?></td>
                    <td bgcolor="#F8F8F8"><?php echo $p_name; ?></td>
                    <td bgcolor="#F8F8F8"><?php echo $batch; ?></td>
                    <td align="right" bgcolor="#F8F8F8"><?php echo number_format($e_amt, 2); ?></td>
                    <td align="right" bgcolor="#F8F8F8"><?php echo number_format($i_amt, 2); ?></td>
                    <td align="right" bgcolor="#F8F8F8"><?php echo number_format($balance, 2); ?></td>
                  </tr>
                  <?php } ?>
                </table></td>
              </tr>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='a_summary.php?cps=$cps&lps=$lps'>=>></a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
