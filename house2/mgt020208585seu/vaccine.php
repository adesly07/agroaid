...
$sql1 = mysql_query("select * from vaccine where v_type = '$v_type'");
if(mysql_num_rows($sql1)) {
$msg = "Record Already Exist";	
} else {
$sql2 = mysql_query ("insert into vaccine set v_type = '$v_type', c_by = '$name', ip = '$ip'");
if ($sql2) {
$msg = "Vaccine Added Successfully";
} else {
//die(mysql_error());
$msg = "Error In Adding Vaccine";
}
}
}
...
<?php include ('menu.php'); ?>   
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Create Vaccine Type</h2>
				<div class="sign-up-row widget-shadow">
<div class="alert alert-success" role="alert">
<strong><?php echo $msg;?></strong></div>
<form action="vaccine.php" method="post" enctype="multipart/form-data">
<div class="sign-u">
  <div class="clearfix"> </div>
</div>
					<div class="sign-u">
          <p>
            <input type="text" name="v_type" placeholder="Vaccine Name" required="" id="v_type" autofocus>
          </p>
<div class="sub_home">
<input type="submit" name="Submit" value="Add">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="400" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="3" align="center"><div class="alert alert-success" role="alert"><strong>Vaccine Type</strong></div></td>
		      </tr>
			  <tr>
			    <td height="30" align="left"><strong>Vaccine Name</strong></td>
			    <td align="left"><strong>Created By</strong></td>
			    <td align="center">&nbsp;</td>
		      </tr>
			  <?php
	 $sql3 = mysql_query("select * from vaccine order by id desc");
	...
	?>
			  <tr>
			    <td width="128" height="30"><?php echo $myv_type; ?></td>
			    <td width="156" align="left"><?php echo $myc_by; ?></td>
			    <td align="center"><a href="vaccine.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
