...
//$month = $_POST['month'];
$year = $_POST['year'];
$sql2 = mysql_query("select * from create_login where username = '$u_name'");
...
$_SESSION['year'] = $year;
header ('location: sales_report5.php');
} elseif ($section == 'Stakeholder') {
//$_SESSION['month'] = $month;
$_SESSION['year'] = $year;
header ('location: sales_report5.php');
}
elseif ($section == 'Coordinator') {
//$_SESSION['month'] = $month;
$_SESSION['year'] = $year;
header ('location: sales_report5.php');
}
...
header ('location: sales_report6.php');
}
}
				...
				<div class="profile_details_left"><!--notifications of menu start -->
					<ul class="nofitications-dropdown">
					  <li class="dropdown head-dpdn">
						...
						| <a href="s_report.php">Back </a> | <a href="m_report.php">Monthly Report</a> | <a href="y_report.php">Yearly Report</a></li>
                    </ul>
...
<div class="main-page signup-page">
				<h2 class="title1">YEARLY SALES REPORT</h2>
				<div class="sign-up-row widget-shadow">
<div class="alert alert-success" role="alert">
<strong><?php echo $msg;?></strong></div>
<form action="y_report.php" method="post" enctype="multipart/form-data">
<div class="sign-u">
  <div class="clearfix"> </div>
</div>
<p>
		    <input name="year" type="text" id="year" readonly="readonly" value="<?php echo date('Y'); ?>" required="">
<p>
  <input name="u_name" type="text" id="u_name" class="auto" autofocus="autofocus">
</p>
