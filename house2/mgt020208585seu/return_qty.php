...
$r_qty = ($myqty1 - $myqty2);
$myamount = $r_qty * $myrate;
$myamount2 = $myqty2 * $myrate;
$sql2 = mysql_query("insert into s_return set batch = '$mybatch', p_name = '$myp_name', r_no = '$myr_no', s_item = '$mys_item', item = '$myitem', quantity = '$r_qty', rate = '$myrate', amount = '$myamount', s_by = '$mys_by', s_date = '$mys_date', s_time = '$mys_time', ip = '$ip', reason = '$reason', r_user = '$name'");
if ($sql2) {
$sql3 = mysql_query("update sales set quantity = '$myqty2', amount = '$myamount2' where id = '$id'");	
if ($sql3) {
...
<tr>
			  ...
			  <tr>
			    <td height="30" align="left"><form name="form1" method="post" action="return_qty.php">
			      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-hover">
			        ...
			        <tr>
			          ...
			          <td><input name="sn" type="hidden" id="sn" value="<?php echo $sn; ?>">
			            ...
			            <input name="s_date" type="hidden" id="s_date" value="<?php echo $s_date; ?>">
			            <input name="s_item" type="hidden" id="s_item" value="<?php echo $s_item; ?>"></td>
			        ...
			        <tr>
			          ...
			          <td height="30"><input name="qty2" type="text" id="qty2" value="<?php echo $qty; ?>"></td>
