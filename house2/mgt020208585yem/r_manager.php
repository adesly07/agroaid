...
$sql1 = mysql_query("select * from f_activities where m_name = '$m_name'");
if(mysql_num_rows($sql1)) {
$msg = "Record Already Exist";	
} else {
$sql2 = mysql_query ("insert into f_activities set m_name = '$m_name', c_by = '$name', ip = '$ip'");
if ($sql2) {
...
if (isset($_GET['id']))
	{
		...
		$sql = "DELETE FROM f_activities WHERE id ='$id'";
...
<?php include ('menu.php'); ?>   
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Register Farm Manager</h2>
				<div class="sign-up-row widget-shadow">
<div class="alert alert-success" role="alert">
<strong><?php echo $msg;?></strong></div>
<form action="r_manager.php" method="post" enctype="multipart/form-data">
<div class="sign-u">
  <div class="clearfix"> </div>
</div>
					<div class="sign-u">
          ...
          <p>
            <input type="text" name="m_name" placeholder="Name" required="" id="m_name" autofocus>
          </p>
<div class="sub_home">
<input type="submit" name="Submit" value="Register">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="400" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="3" align="center"><div class="alert alert-success" role="alert"><strong>Farm Managers</strong></div></td>
		      </tr>
			  <tr>
			    ...
			    <td width="63" align="center">&nbsp;</td>
						  ...
						  <?php
	 $sql3 = mysql_query("select * from f_activities order by id desc");
	...
	?>
  <tr>
			    <td width="164" height="30"><?php echo $mym_name; ?></td>
			    <td width="165" align="left"><?php echo $myc_by; ?></td>
			    <td align="center"><a href="r_manager.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
