...
*/
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='sales_report4.php?cps=$lps'><<=</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from sales where month = '$month' and year = '$year' and p_status = 'PAID' and cashier = '$myname' order by id ASC limit $cps, $rpp "; 
...
<tr>
  ...
  while ($row = mysql_fetch_array($rs)) {
 	$cps = $cps +1;
		...
		$batch = $row['batch'];
		$p_name = $row['p_name'];
 $sql4 = mysql_query("select sum(amount) from sales where month = '$month' and year = '$year' and p_status = 'PAID' and s_by = '$myname'");
  ...
  ?>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='sales_report4.php?cps=$cps&lps=$lps'>=>></a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
