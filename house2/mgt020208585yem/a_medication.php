...
$t_amt = ($u_price * $qty);
$unit = ($qty * $q_unit);
$sql2 = mysql_query ("insert into stocks set category = 'Medication', type = '$type', quantity = '$qty', unit = '$unit', u_price = '$u_price', t_amt = '$t_amt', s_date = '$s_date', c_by = '$name', ip = '$ip'");
if ($sql2) {
$msg = "Medication Stocked Successfully";
} else {
//die(mysql_error());
$msg = "Error In Stocking Medication";
}
}
...
<?php include ('menu.php'); ?>   
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Add Medication </h2>
				<div class="sign-up-row widget-shadow">
<div class="alert alert-success" role="alert">
<strong><?php echo $msg;?></strong></div>
<form action="a_medication.php" method="post" enctype="multipart/form-data">
<div class="sign-u">
  <div class="clearfix"> </div>
</div>
					<div class="sign-u">
          <p><strong>Medicine Type</strong></p>
          <p><span class="sign-u">
...
<input type="submit" name="Submit" value="Add">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="4" align="center"><div class="alert alert-success" role="alert"><strong>Medication Stocked</strong></div></td>
		      </tr>
			  <tr>
			    ...
			    <td width="24" align="center">&nbsp;</td>
						  ...
						  <?php
	 $sql3 = mysql_query("select * from stocks where category = 'Medication' order by id desc limit 5");
  ...
  <tr>
	    ...
	    <td align="center"><a href="a_medication.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
