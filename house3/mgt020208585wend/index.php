		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><span class="title1"><a href="d_feeding.php">Daily Feeding</a></span></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-pie-chart dollar1 icon-rounded"></i>
                    <div class="stats">
                      <h5><span class="title1"><a href="medic.php">Medication</a></span></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-pie-chart dollar1 icon-rounded"></i>
                    <div class="stats">
                      <h5><span class="title1"><a href="vacci.php">Vaccination</a></span></h5>
                      <span class="cred"><b>&nbsp; </b></span> <span class="cgreen">&nbsp;</span><br>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-pie-chart dollar1 icon-rounded"></i>
                    <div class="stats">
                      <h5><span class="title1"><a href="v_weight.php">Weight Management</a></span></h5>
                      <hr>
  <h6><span class="cred"><a href="m_rate.php">Mortality Rate</a></span></h6>                    
 </div>
        		</div>
        	 </div>
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-pie-chart dollar1 icon-rounded"></i>
                    <div class="stats">
                      <h5><span class="title1"><a href="history.php">History</a></span></h5>
 </div>
                </div>
        	 </div>
        	<div class="clearfix"> </div>
		...
		<div class="row-one widgettable">
				...
				<div class="agileinfo-cdr">
					 <div class="cgreen">
					    <h4><strong>DAILY FEEDING GRAPH (<?php echo $d_date; ?>)</strong> | <a href="d_feed/graphical.html">Enlarge Graph</a></h4> </div>
                        <p>&nbsp;</p>
						<div style="width: 100%; height: 350px">
<div></div>
<iframe src="d_feed/graphical.html" name="I1" width="100%" marginwidth="1" height="100%" marginheight="1" scrolling="Yes" frameborder="0" class="mtable" id="I1" border="0"> Your browser does not support inline frames or is currently configured not to display inline frames. </iframe>
<p>&nbsp;</p>
					    <p>&nbsp;</p>
						</div>
