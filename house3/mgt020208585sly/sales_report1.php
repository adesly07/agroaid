...
*/
 ...
 @ $rpp;        //Records Per Page 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from sales where s_date = '$s_date' and p_status = 'PAID' order by id ASC limit $cps, $rpp "; 
...
<tr>
			    <td width="69" align="center"><div class="alert alert-success" role="alert"><span class="stock"><strong>SALES REPORT AS AT <?php echo $s_date; ?></strong></span> | <a href="s_graph/graphical.html">View Graph</a></div></td>
		      </tr>
			  <tr>
 ...
 $sql4 = mysql_query("select sum(amount) from sales where s_date = '$s_date' and p_status = 'PAID'");
