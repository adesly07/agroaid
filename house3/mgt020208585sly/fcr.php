...
$batch = $_SESSION['batch'];
 ...
 @ $rpp;        //Records Per Page 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from stock_items where p_name = '$p_name' and batch = '$batch' order by 'id' asc limit $cps, $rpp "; 
...
<tr>
			    <td align="center"><div class="alert alert-success" role="alert"><span class="stock"><strong>ECONOMIC FEED CONVERSION RATIO (<?php echo $p_name; ?>, <?php echo $batch; ?>)</strong></span></div></td>
		      </tr>
              <tr>
			      ...
			      <tr>
			        <td width="76%" valign="top"><table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			          <tr>
			            ...
			            <td width="232" align="center"><strong>FCR</strong></td>
		              </tr>
			          <?php
...
$fcr = ($f_bird/$mysize);
	...
	?>
			          <tr>
			            ...
			            <td width="87" height="30"><?php echo $myitem; ?></td>
			            <td width="123" align="center"><?php echo $mysize; ?></td>
			            <td width="143" align="center"><?php echo $myqty; ?></td>
			            <td align="left"><?php echo round($fcr,4); ?>:1</td>
		              </tr>
			          <?php } ?>
		            </table></td>
		          </tr>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='fcr.php?cps=$cps&lps=$lps'>=>></a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
