...
$sql1 = "SELECT DISTINCT(m_name)
		FROM f_activities order by id asc";
...
$sql2 = mysql_query ("insert into f_scheduling set m_name = '$m_name', s_day = '$s_day', c_by = '$name', ip = '$ip'");
if ($sql2) {
$msg = "Schedule Added Successfully";
} else {
//die(mysql_error());
$msg = "Error In Adding Schedule";
}
}
...
<?php include ('menu.php'); ?>   
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Farm Activity Scheduling </h2>
...
<div class="sign-u">
  <div class="clearfix"> </div>
          ...
          <p>
            <select name="s_day" id="s_day" class="form-control">
...
<input type="submit" name="Submit" value="Add">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="5" align="center"><div class="alert alert-success" role="alert"><strong>Farm Activities Scheduling</strong></div></td>
		      </tr>
			  <tr>
			    ...
			    <td width="24" align="center">&nbsp;</td>
						  ...
						  <?php
	 $sql3 = mysql_query("select * from f_scheduling order by id desc limit 20");
	...
	?>
  <tr>
			    <td width="35" height="30"><?php echo $mym_name; ?></td>
			    <td width="34" height="30"><?php echo $mys_day; ?></td>
	    <td align="center"><a href="scheduling.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
