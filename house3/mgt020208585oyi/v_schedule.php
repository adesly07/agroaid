...
*/
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='v_schedule.php?cps=$lps'><<=</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from f_scheduling order by id ASC limit $cps, $rpp "; 
...
if (isset($_GET['id']))
	{
		...
		$sql = "DELETE FROM f_scheduling WHERE id ='$id'";
...
<tr>
			    <td align="center"><div class="alert alert-success" role="alert"><span class="stock"><strong>FARM MANAGER SCHEDULING </strong></span></div></td>
		      </tr>
              <tr>
			      ...
			      <tr>
			        <td width="76%" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="0">
			          <tr>
			            ...
			            <td width="32%" align="center"><strong>Name</strong></td>
			            <td width="37%" align="center"><strong>Day</strong></td>
			            <td width="9%">&nbsp;</td>
		              </tr>
			          <?php
  ...
  while ($row = mysql_fetch_array($rs)) {
	...
	$mys_day = $row['s_day'];
		 ?>
			          <tr>
			            ...
			            <td height="30" align="left">&nbsp;<?php echo $mym_name; ?></td>
			            <td height="30">&nbsp;<?php echo $mys_day; ?></td>
			            <td align="center"><a href="v_schedule.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		              </tr>
			          <?php } ?>
		            </table></td>
		          </tr>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='v_schedule.php?cps=$cps&lps=$lps'>=>></a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
