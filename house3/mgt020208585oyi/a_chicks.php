...
$t_amt = ($u_price * $qty);
$sql2 = mysql_query ("insert into stocks set batch = '$batch', category = 'Chicks', type = '$type', p_name = '$p_name', quantity = '$qty', unit = '$unit', u_price = '$u_price', t_amt = '$t_amt', s_date = '$s_date', c_by = '$name', ip = '$ip'");
if ($sql2) {
$msg = "Chicks Stocked Successfully";
} else {
die(mysql_error());
$msg = "Error In Stocking Chicks";
}
}
...
<?php include ('menu.php'); ?>   
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Add Chicks </h2>
				<div class="sign-up-row widget-shadow">
<div class="alert alert-success" role="alert">
<strong><?php echo $msg;?></strong></div>
<form action="a_chicks.php" method="post" enctype="multipart/form-data">
          ...
          <p>
            <input type="text" name="unit" placeholder="Age" required="" id="unit" value="Day Old">
          </p>
   ...
   <p>
          ...
          <p><strong>Unit Price</strong></p>
                   <p>
            <input type="text" name="u_price" placeholder="Unit Price" required="" id="u_price">
          </p>
...
<input type="submit" name="Submit" value="Add">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="6" align="center"><div class="alert alert-success" role="alert"><strong>Chicks Stocked</strong></div></td>
		      </tr>
			  <tr>
			    ...
			    <td width="24" align="center">&nbsp;</td>
						  ...
						  <?php
	 $sql3 = mysql_query("select * from stocks where category = 'Chicks' order by id desc limit 5");
	...
	?>
  <tr>
			    <td width="35" height="30"><?php echo $mytype; ?></td>
			    <td width="34" height="30"><?php echo $myp_name; ?></td>
			    <td width="34"><?php echo $mybatch; ?></td>
			    <td width="99" align="center"><?php echo $myqty; ?></td>
			    <td align="right"><?php echo number_format($myprice,2); ?></td>
	    <td align="center"><a href="a_chicks.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
