...
$id = $_REQUEST['id'];
	 $sql3 = mysql_query("select * from m_mgt where id = '$id'");
   ...
   <div class="col-md-12  widget-shadow">
      <div class="panel-default">
        <div class="inbox-page">
          <div class="cgreen"><strong>Medication</strong></div>
          
          <div class="bs-example widget-shadow" data-example-id="hoverable-table">
            <table width="95%" border="1" cellpadding="0" cellspacing="0" class="table table-hover"> <thead> <tr> <th width="28%" height="30" align="left"><strong>Date</strong></th>
<td width="72%" height="30" align="left"><?php echo $m_date; ?></td>
						</tr> 
					    </thead> <tbody>
    			<tr> <td height="30" scope="row"><strong>Time</strong></td>
           <td height="30" align="left"><?php echo $m_time; ?></td>
                          </tr>
                         <tr>
                         ...
                         <tr>
                           ...
                           <td height="30" align="left"><?php echo $m_used; ?></td>
                         </tr>
                         <tr>
