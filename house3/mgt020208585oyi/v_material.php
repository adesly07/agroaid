...
*/
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='v_material.php?cps=$lps'><<=</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from dispense where p_status = 'DISPENSED' order by id ASC limit $cps, $rpp "; 
...
if (isset($_GET['id']))
	{
		...
		$sql = "DELETE FROM dispense WHERE id ='$id'";
...
<tr>
			    <td align="center"><div class="alert alert-success" role="alert"><span class="stock"><strong>DISPENSED MATERIAL</strong></span></div></td>
		      </tr>
              <tr>
			    <td width="69" height="30"><table width="100%" border="0">
			      ...
			      <tr>
			        <td width="76%" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="0">
			          <tr>
			            <td align="center"><strong>#</strong></td>
			            <td align="center"><strong>Dispense No.</strong></td>
			            <td align="center"><strong>Type</strong></td>
			            <td align="center"><strong>Quantity</strong></td>
			            <td align="center"><strong>Receiver's Name</strong></td>
			            <td align="center"><strong>Dispensed By</strong></td>
			            <td align="center"><strong>Date</strong></td>
			            <td>&nbsp;</td>
		              </tr>
			          <?php
		// $sql3 = mysql_query("select * from dispense where p_status = 'DISPENSED' and batch = '$batch'");
  while ($row = mysql_fetch_array($rs)) {
		...
		$s_date = $row ['s_date'];
		 ...
		 ?>
			          <tr>
			            ...
			            <td height="30" align="left"><?php echo $d_no; ?></td>
			            <td height="30"><?php echo $type; ?></td>
			            <td height="30" align="center"><?php echo $qty; ?></td>
			            <td height="30" align="left"><?php echo $r_name; ?></td>
			            <td align="left"><?php echo $s_by; ?></td>
			            <td align="center"><?php echo $s_date; ?></td>
			            <td align="center"><a href="v_material.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		              </tr>
			          <?php } ?>
		            </table></td>
		          </tr>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='v_material.php?cps=$cps&lps=$lps'>=>></a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
