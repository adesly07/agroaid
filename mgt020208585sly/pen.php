...
$sql1 = mysql_query("select * from pen where p_name = '$p_name'");
if(mysql_num_rows($sql1)) {
$msg = "Record Already Exist";	
} else {
$sql2 = mysql_query ("insert into pen set p_name = '$p_name', c_by = '$name', ip = '$ip'");
if ($sql2) {
$msg = "Pen Created Successfully";
} else {
//die(mysql_error());
$msg = "Error In Creating Pen";
}
}
}
...
if (isset($_GET['id']))
	{
		...
		$sql = "DELETE FROM pen WHERE id ='$id'";
...
<?php include ('menu.php'); ?>          <!-- /.navbar-collapse -->
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Create Pen</h2>
				<div class="sign-up-row widget-shadow">
<div class="alert alert-success" role="alert">
<strong><?php echo $msg;?></strong></div>
<form action="pen.php" method="post" enctype="multipart/form-data">
<div class="sign-u">
  <div class="clearfix"> </div>
</div>
					<div class="sign-u">
          <p>
            <input type="text" name="p_name" placeholder="Pen Name" required="" id="p_name" autofocus>
          </p>
<div class="sub_home">
<input type="submit" name="Submit" value="Add">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="400" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="3" align="center"><div class="alert alert-success" role="alert"><strong>Pen Name</strong></div></td>
		      </tr>
			  <tr>
			    <td height="30" align="left"><strong>Pen Name</strong></td>
			    <td align="left"><strong>Created By</strong></td>
			    <td width="63" align="center">&nbsp;</td>
		      </tr>
						  <?php
	 $sql3 = mysql_query("select * from pen order by id desc");
	...
	?>
  <tr>
			    <td width="164" height="30"><?php echo $myp_name; ?></td>
			    <td width="165" align="left"><?php echo $myc_by; ?></td>
			    <td align="center"><a href="pen.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
