...
$sql2 = mysql_query("select sum(t_amt) from stocks where category = 'Chicks' and batch = '$batch'");
...
<tr>
			    <td width="69" align="center"><div class="alert alert-success" role="alert"><strong>SUMMARY OF EXPENSES (<?php echo $batch; ?>)</strong></div></td>
		      </tr>
              <tr>
              ...
              <tr>
                <td height="30"><table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
                  <tr>
                    ...
                    <td width="140" align="center"><strong>Amount(&#8358;)</strong></td>
                    <td width="125" align="center"><strong>Date</strong></td>
                  </tr>
                  <?php
	 $sql1 = mysql_query("select * from stocks where category = 'Chicks' and batch = '$batch'");
...
$c_amt = $row[0];	
	...
	?>
                  <tr>
                    ...
                    <td width="65" height="30"><?php echo $myp_name; ?></td>
              ...
              <tr>
                <td height="30" align="right"><strong>Total Amount(&#8358;):</strong><strong class="cgreen"><?php echo number_format($c_amt,2); ?></strong></td>
      </tr>
              <tr>
              ...
              <tr>
                <td height="30" align="left"><table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
                  <tr>
                    ...
                    <td align="center"><strong>Quantity/Bag</strong></td>
                    <td width="133" align="center"><strong>Unit Price(&#8358;)</strong></td>
                    <td width="139" align="center"><strong>Amount(&#8358;)</strong></td>
                     <td width="123" align="center"><strong>Date</strong></td>
                 </tr>
                  <?php
	 $sql3 = mysql_query("select * from stocks where category = 'Feeds' and batch = '$batch'");
...
$f_amt = $row[0];	
	...
	?>
                  <tr>
                    ...
                    <td width="140" align="left"><?php echo $myqty; ?></td>
                    <td align="right"><?php echo number_format($myprice,2); ?></td>
                    <td align="right"><?php echo number_format($t_amt,2); ?></td>
                     <td align="center"><?php echo $mys_date; ?></td>
                  </tr>
              ...
              <tr>
                <td height="30" align="right"><strong>Total Amount(&#8358;):</strong><strong class="cgreen"><?php echo number_format($f_amt,2); ?></strong></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="30" align="left"><table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
                  <tr>
                    ...
                    <td align="center"><strong>Quantity/Pack</strong></td>
                    <td width="120" align="center"><strong>Unit Price</strong></td>
                    <td width="148" align="center"><strong>Total Amount(&#8358;)</strong></td>
                    <td width="113" align="center"><strong>Date</strong></td>
                 </tr>
                  <?php
	 $sql5 = mysql_query("select * from stocks where category = 'Vaccine' and batch = '$batch'");
...
$v_amt = $row[0];	
	...
	?>
                  <tr>
                    ...
                    <td width="162" align="left"><?php echo $myqty; ?></td>
                    <td align="right"><?php echo number_format($myprice,2); ?></td>
                    <td align="right"><?php echo number_format($t_amt,2); ?></td>
                     <td align="center"><?php echo $mys_date; ?></td>
                  </tr>
              ...
              <tr>
                <td height="30" align="right"><strong>Total Amount(&#8358;):</strong><strong class="cgreen"><?php echo number_format($v_amt,2); ?></strong></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="30" align="left"><table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
                  <tr>
                    ...
                    <td width="149" align="center"><strong>Amount(&#8358;)</strong></td>
                    <td width="125" align="center"><strong>Date</strong></td>
                  </tr>
                  <?php
	 $sql7 = mysql_query("select * from stocks where category = 'Medication' and batch = '$batch'");
...
$m_amt = $row[0];	
	...
	?>
                  <tr>
                    ...
                    <td width="106" align="left"><?php echo $myqty; ?></td>
                    <td align="right"><?php echo number_format($myprice,2); ?></td>
                    <td align="right"><?php echo number_format($t_amt,2); ?></td>
                     <td align="center"><?php echo $mys_date; ?></td>
                 </tr>
              ...
              <tr>
                <td height="30" align="right"><strong>Total Amount(&#8358;):</strong><strong class="cgreen"><?php echo number_format($m_amt,2); ?></strong></td>
              </tr>
              <tr>
                <td height="30" align="left"><strong class="cred">MISCELLANEOUS</strong></td>
              </tr>
              <tr>
                <td height="30" align="left"><table width="600" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
                  <tr>
                    <td width="430" height="30" align="center"><strong>Description</strong></td>
                    <td width="127" align="center"><strong>Quantity</strong></td>
                    <td width="113" align="center"><strong>Unit Price(&#8358;)</strong></td>
                    <td width="27" align="center"><strong>Amount(&#8358;)</strong></td>
                    <td width="113" align="center"><strong>Date</strong></td>
                  </tr>
                  <?php
	 $sql9 = mysql_query("select * from stocks where category = 'Miscellaneous' and batch = '$batch'");
...
$misc_amt = $row[0];	
	...
	?>
                  <tr>
                    <td height="30"><?php echo $mytype; ?></td>
                    <td height="30"><?php echo $myqty; ?></td>
                    <td align="right"><?php echo number_format($myprice,2); ?></td>
                    <td align="right"><?php echo number_format($t_amt,2); ?></td>
                    <td align="center"><?php echo $mys_date; ?></td>
                  </tr>
              ...
              <tr>
                <td height="30" align="right"><strong>Total Amount(&#8358;):</strong><strong class="cgreen"><?php echo number_format($misc_amt,2); ?></strong></td>
      </tr>
