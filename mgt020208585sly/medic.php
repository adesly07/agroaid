...
$pen = $row['p_name'];	
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='medic.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from m_mgt ORDER BY 'id' DESC  limit $cps, $rpp "; 
			...
			<div class="main-page">
			  ...
			  <div class="row-one widgettable">
				...
				<div class="agileinfo-cdr">
					 <div class="cgreen">
					    <h4><strong>MEDICATION</strong></h4> </div>
                        <p>
                          <iframe src="f_med/graphical.html" name="I1" width="100%" marginwidth="1" height="400" marginheight="1" scrolling="Yes" frameborder="0" class="mtable" id="I1" border="0"> Your browser does not support inline frames or is currently configured not to display inline frames. </iframe>
                        </p>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row"><a href="v_medi.php?id=<?php echo $sn; ?>" rel="facebox"><?php echo $m_date; ?></a></td>
...
<p>&nbsp;</p>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='medic.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
