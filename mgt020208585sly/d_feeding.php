...
$pen = $row['p_name'];	
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='d_feeding.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
			  ...
			  <div class="row-one widgettable">
				...
				<div class="agileinfo-cdr">
					 <div class="cgreen">
                        ...
                        <p>
                          <iframe src="d_feed/graphical.html" name="I1" width="100%" marginwidth="1" height="400" marginheight="1" scrolling="Yes" frameborder="0" class="mtable" id="I1" border="0"> Your browser does not support inline frames or is currently configured not to display inline frames. </iframe>
                        </p>
                        <p></p>
						<div style="width: 100%; height: 100%">
<div><? echo "Showing Records from $a to $b of $nr0"; ?></div>
					    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="table table-hover"> <thead> 
					      <tr>
					        <th colspan="9" align="center">&nbsp;</th>
				          </tr>
					      <tr> <td width="7%" align="center"><strong>#</strong></td>
					    <td width="10%" align="center"><strong>Date</strong></td> 
					    <td width="10%" align="center"><strong>Time</strong></td>
					    <td width="9%" align="center"><strong>Pen</strong></td> 
					    <td width="10%" align="center"><strong>Batch</strong></td> 
                        <td width="14%" align="center"><strong>Feed Used</strong></td>
						<td width="13%" align="center"><strong>Quantity<br>
Used (KG)</strong></td>
						<td width="14%" align="center"><strong>Available<br>
Stock (KG)</strong></td>
						<td width="13%" align="center"><strong>Mortality<br>
Rate (<span class="cred"><?php echo $mortal; ?></span>)</strong></td>
						  </tr> 
					    </thead> <tbody>
                        <?php
...
*/		?>
                         ...
                         <tr> <td align="center" scope="row"><?php echo $cps ?></td>
                           ...
                           <td align="center"><span class="<?php echo $color; ?>"><?php echo $a_stock; ?></span></td>
                           <td align="center"><span class="cred"><?php echo $m_rate; ?></span></td>
                          </tr> 
                         <?php
 } ?>  
                         </tbody> </table>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='d_feeding.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>
