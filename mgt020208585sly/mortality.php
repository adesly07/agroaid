...
<tr>
			    <td align="center"><div class="alert alert-success" role="alert"><span class="stock"><strong>MORTALITY RATE (<?php echo $p_name; ?>, <?php echo $batch; ?>)</strong></span> <a href="m_graph/graphical.html">Enlarge Graph</a></div></td>
		      </tr>
              <tr>
			    <td width="69" height="30"><table width="100%" border="0" class="table table-hover">
			      <tr>
			        <td valign="top"><iframe src="m_graph/graphical.html" name="I1" width="100%" marginwidth="1" height="400" marginheight="1" scrolling="Yes" frameborder="0" id="I1" border="0"> Your browser does not support inline frames or is currently configured not to display inline frames. </iframe></td>
		          </tr>
			      <tr>
...
$m_rate = ($mymortal/$myc_qty) * 100;	
    ...
    ?>
			...
			<p>&nbsp;</p>
<p>&nbsp;</p>
           </div> 					<div class="bs-example widget-shadow" data-example-id="hoverable-table"></div>
		</div>
		<!--footer-->
		<div class="footer">
