...
$sql1 = mysql_query("select * from feeds where f_type = '$f_type'");
if(mysql_num_rows($sql1)) {
$msg = "Record Already Exist";	
} else {
$sql2 = mysql_query ("insert into feeds set f_type = '$f_type', c_by = '$name', ip = '$ip'");
if ($sql2) {
$msg = "Feed Added Successfully";
} else {
//die(mysql_error());
$msg = "Error In Adding Feed";
}
}
}
...
<?php include ('menu.php'); ?>   
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Create Feed Type</h2>
...
<div class="sign-u">
  <div class="clearfix"> </div>
					...
					<div class="sign-u">
          <p>
            <input type="text" name="f_type" placeholder="Feed Name" required="" id="f_type" autofocus>
          </p>
<div class="sub_home">
<input type="submit" name="Submit" value="Add">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="400" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="3" align="center"><div class="alert alert-success" role="alert"><strong>Feed Type</strong></div></td>
		      </tr>
			  <tr>
			    <td height="30" align="left"><strong>Feed Name</strong></td>
			    <td align="left"><strong>Created By</strong></td>
			    <td width="63" align="center">&nbsp;</td>
		      </tr>
						  <?php
	 $sql3 = mysql_query("select * from feeds order by id desc");
	...
	?>
  <tr>
			    <td width="164" height="30"><?php echo $myf_type; ?></td>
			    <td width="165" align="left"><?php echo $myc_by; ?></td>
			    <td align="center"><a href="feeds.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
