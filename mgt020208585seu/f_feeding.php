...
$f_qty = ($f_qty1 + $qty);
	...
	$fkg = ($s_qty * 25);
	$a_stock = ($fkg - $f_qty);
$sql2 = mysql_query ("insert into f_mgt set batch = '$batch', f_date = '$f_date', f_time = CURTIME(), p_name = '$p_name', b_type = '$b_type', f_used = '$f_used', f_qty = '$qty', a_stock = '$a_stock', mortality = '$mortality', comment = '$comment', day = '$day', month = '$month', year = '$year', c_by = '$name', ip = '$ip'");
if ($sql2) {
$sql4 = mysql_query ("insert into f_mgt2 set batch = '$batch', f_date = '$f_date', f_time = CURTIME(), p_name = '$p_name', b_type = '$b_type', f_used = '$f_used', f_qty = '$qty', a_stock = '$a_stock', mortality = '$mortality', comment = '$comment', day = '$day', month = '$month', year = '$year', c_by = '$name', ip = '$ip'");
} if($sql4) {
...
<div class="sign-u">
 ...
 <p><strong>Type of Bird</strong></p>
          ...
          <p>
            <input type="text" name="mortality" placeholder="Mortality Rate" id="mortality">
</p>
                    <p>
...
<input type="submit" name="Submit" value="OK">
		  ...
		  <p>&nbsp;</p>
			...
			<table width="1095" border="1" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
			  <tr>
			    <td colspan="8" align="center"><div class="alert alert-success" role="alert"><strong>Daily Feeding</strong></div></td>
		      </tr>
			  <tr>
			    <td align="center">&nbsp;</td>
			    ...
			    <td width="59" align="center"><strong>Mortality</strong></td>
		      </tr>
						  <?php
	 $sql3 = mysql_query("select * from f_mgt order by id desc limit 5");
	...
	?>
  <tr>
    <td width="70" align="center"><a href="f_feeding.php?id=<?php echo $sn; ?>" onClick="return check_deletion()"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete record"></i></a></td>
			    <td width="111" height="30"><?php echo $myf_date; ?></td>
			    <td width="158" height="30"><?php echo $myp_name; ?></td>
			    <td width="158"><?php echo $mybatch; ?></td>
  ...
  <td align="center"><?php echo $mymortal; ?></td>
		      </tr>
			  <?php } ?>
		  </table>
			<p>&nbsp;</p>
